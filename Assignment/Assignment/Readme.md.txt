1. For the code please see: " imgDisplay.cpp, vidDisplay.cpp, filters.cpp, filters.h  " file.
2. PDF named " PRCV_Assignment_1 " contains the report. The alignments of the images in the report are little bit distorted,
	 so I have mentioned in the report which figure to refer for which part.
3. By pressing these following keys we can implement particular filters:
...
I submitted the coding assignment on time, but I forgot to upload the readme, and report PDF. So I got little late and uploading
